...
@import UIKit;
#import "RNBackgroundTimerChatVT.h"

@implementation RNBackgroundTimerChatVT {
...
{
    [self _stop];
    bgTask = [[UIApplication sharedApplication] beginBackgroundTaskWithName:@"RNBackgroundTimerChatVT" expirationHandler:^{
...
RCT_EXPORT_METHOD(setTimeout:(int)timeoutId
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    __block UIBackgroundTaskIdentifier task = [[UIApplication sharedApplication] beginBackgroundTaskWithName:@"RNBackgroundTimerChatVT" expirationHandler:^{
