...
export const Icon = ({
  ...
  switch (iconName) {
    ...
    case 'Football':
      return (
        <PngIcon fill={color} source={require('../assets/football.png')} />
      );
    case 'Lightbulb':
      return (
        <PngIcon fill={color} source={require('../assets/lightbulb.png')} />
      );
    case 'Flag':
    ...
    case 'QuestionMark':
      return (
        <PngIcon fill={color} source={require('../assets/questionMark.png')} />
      );
    default:
