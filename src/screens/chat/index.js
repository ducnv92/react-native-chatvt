            ...
            >
              <TouchableOpacity
                onPress={() => {
                  try {
                    Navigation.pop(
                      props.componentId ? props.componentId : 'ChatScreen'
                    );
                  } catch (e) {}
                }}
                style={{
                  ...
                  >
                    ...
                    >
                      {conversation?.type === 'GROUP'
                        ? 'Đơn ' +
                          (conversation?.order_numbers?.length > 0 &&
                            conversation?.order_numbers[0])
                    ...
                    {receiver?.state?.includes('ONLINE') ? (
                      ...
                      >
                        {receiver.type === 'VTMAN'
                          ...
                          : 'Hoạt động ' +
                            timeSince(receiver.last_state_update)}
                      </Text>
