                ...
                >
                    <View style={{ flexDirection: 'row' }}>
                        <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            >
                                {order.order_number?order.order_number:(order?.ma_phieugui?order?.ma_phieugui:order?.ma_vandon)}
                            </Text>
                            {/*<View*/}
                            {/*  style={{*/}
                            {/*    paddingVertical: 5,*/}
                    ...
                    >
                        {order?.ten_khnhan ? order?.ten_khnhan : (order.ten_khgui?order.ten_khgui:(order.ten_nguoigui?order.ten_nguoigui:order?.receiver_fullname))} - {order.dienthoai_nguoigui?order.dienthoai_nguoigui:(order?.tel_khnhan ? order?.tel_khnhan : order?.receiver_phone)}
                    </Text>
                    <Text
                        style={{
                            fontWeight: '500',
                    ...
                    >
                        {order?.order_description?order?.order_description:productNames?productNames:(order.product_name?order.product_name:order.mota_sp)}
                    </Text>
                </View>
                {/*{*/}
                {/*  item.status === 'sending' &&*/}
