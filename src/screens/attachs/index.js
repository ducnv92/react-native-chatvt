  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.primary }}>
      ...
      >
        <TouchableOpacity
          ...
          style={{
            ...
            borderBottomWidth: 2,
            borderColor:
              attachsStore?.currentTab === 0 ? colors.primary : '#DCE6F0',
          }}
        >
          <Text
            style={{
        ...
        <TouchableOpacity
          ...
          style={{
            ...
            borderBottomWidth: 2,
            borderColor:
              attachsStore?.currentTab === 1 ? colors.primary : '#DCE6F0',
          }}
        >
          <Text
            style={{
      ...
      <FlatList
        ...
        ItemSeparatorComponent={() => (
          <View
            style={{
              backgroundColor:
                attachsStore.currentTab === 0 ? 'black' : 'white',
              height: attachsStore.currentTab === 0 ? 2 : 1,
            }}
          >
            {attachsStore.currentTab === 1 && (
              <View
        ...
        ListEmptyComponent={() => {
          if (attachsStore.isLoading) return null;
          return (
            <View
              style={{
                alignItems: 'center',
            ...
            >
              {attachsStore.currentTab === 0 ? (
                <Image
                  style={{ width: 102, height: 102, resizeMode: 'contain' }}
              ...
              <Text
                style={{ fontWeight: '500', fontSize: 15, color: '#828282' }}
              >
                {attachsStore.currentTab === 0
                  ? 'Chưa có ảnh, video được gửi trong hội thoại '
                  : 'Chưa có tài liệu được gửi trong hội thoại '}
              </Text>
            </View>
          );
        }}
      ...
      >
        {receiver?.type === 'VTMAN' ? (
          <Image
            style={{ height: 94, width: 94, resizeMode: 'contain' }}
